...
<TABLE cellSpacing=0 cellPadding=0 width=748 border=0 height="564">
  ...
  <TR>
    <TD vAlign=middle width=170 height="38" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="left">
      <p><b><font color="#993333" size="3">&nbsp;&nbsp; <a href = "/SeafoodMarket/Servletmain"><font color = "#993333">Income management</font></a></font></b>
    </TD>
    <TD vAlign=top width=567 height="272" rowspan="7">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p align="center">&nbsp;</p>
    <form method="POST" action="/SeafoodMarket/ServletUpdate2" >
    <input type = "hidden" name="income_id" value = "${currentincomeid}">
      ...
      Department Name:
      <select size="1" name="D1" style="background-color: #FDCC64; color: #800000; border-style: solid; border-color: #800000">
        <c:forEach items="${deptlist}" var = "dept">
        <option>${dept.dept_name}</option>
        </c:forEach>
      </select></font></b></p>
      <p align="center"><font color="#993333"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Daliy Income Sum:<input type="text" name="T2" size="20"></b></font></p>
      ...
      <a href ="/SeafoodMarket/jsp/departmentAdd.jsp"><input type="button" value="Add Department" name="B3" style="background-color: #FDCC64; color: #800000; font-weight: bold"></a></p>
    </form>
    </TD>
  </TR>
  <TR>
    <TD vAlign=middle width=170 height="38" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="left">
    <p><b><font color="#993333" size="3">&nbsp;&nbsp;<a href="/SeafoodMarket_Manager/MainServlet"><font color = "#993333">Dept management</font></a></font> </b>
    </TD>
  </TR>
  <TR>
  ...
  <TR>
    <TD vAlign=middle width=170 height="39" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="left">
    <p><b><font color="#993333" size="3">&nbsp;&nbsp; <a href = "/SeafoodMarket/findservlet"><font color="#993333" >Vendor management</a></font></b>
    </TD>
  </TR>
  <TR>
    <TD vAlign=middle width=170 height="39" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="left">
    <p><b><font color="#993333" size="3">&nbsp;&nbsp; <a href = "/SeafoodMarket/venderselectservlet"><font color="#993333" >Bill management</a></font></b>
    </TD>
  </TR>
  <TR>
    <TD vAlign=middle width=170 height="39" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="left">
  ...
  <TR>
    ...
    <p><b><font color="#993333" size="3">&nbsp;&nbsp; <a href = "/SeafoodMarket/jsp/backup.jsp"><font color="#993333" >Backup</font></a> </b>
    </TD>
  </TR>
  <TR>
