...
<TABLE cellSpacing=0 cellPadding=0 width=748 border=0 height="612">
  ...
  <TR>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p align="center">&nbsp;</p>
    <form method="POST"   action ="/SeafoodMarket/updateservlet">
      ...
      <input type="hidden" name="vendor_id" value="${theVd.vendor_id}" />
      <p align="center"><b><font color="#993333">&nbsp;&nbsp; Vendor Name:</font></b><input type="text" name="vendor_name" value ="${theVd.vendor_name}" size="20"></p>
      <p align="center"><b><font color="#993333">Vendor Address</font></b><font color="#993333"><b>:<input type="text" name="vendor_address" value = "${theVd.vendor_address}" size="20"></b></font></p>
      <p align="center"><b><font color="#993333">&nbsp;&nbsp;&nbsp; Vendor phone</font></b><font color="#993333"><b>:<input type="text" name="vendor_phone" value = "${theVd.vendor_phone}" size="20"></b></font></p>
      <p align="center"><b><font color="#993333">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Vendor FAX</font></b><font color="#993333"><b>:<input type="text" name="vendor_fax" value ="${theVd.vendor_fax}" size="20"></b></font></p>
      <p align="center"><font color="#993333"><b>&nbsp;&nbsp; Contact Person:<input type="text" name="vendor_contact_person" value = "${theVd.vendor_contact_person}" size="20"></b></font></p>
      <p align="center"><input  type="submit" value="Update" name="B1" style="color: #800000; font-weight: bold; background-color: #FDCC64" ><input type="reset" value="Cancel" name="B2" style="color: #800000; font-weight: bold; background-color: #FDCC64"></p>
    </form>
    </TD>
  </TR>
  <TR>
