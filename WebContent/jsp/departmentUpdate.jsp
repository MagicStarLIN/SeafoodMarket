...
<TABLE cellSpacing=0 cellPadding=0 width=748 border=0 height="574">
  <TBODY>
  <TR>
    <TD vAlign=middle width=170 height="40" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="right">
    ...
    <form method="POST" action="/SeafoodMarket/UpdateServlet">
      ...
      <p align="center"><b><font color="#993333">Department Name:</font></b><input type="text" name="dept_name" size="20" value=${dept.dept_name }></p>
      <p align="center"><font color="#993333"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Description:<input type="text" name="dept_descreption" size="20" value=${dept.dept_descreption}></b></font></p>
  ...
  <TR>
    <TD vAlign=middle width=170 height="41" bgcolor="#FDCC64" bordercolor="#993333" bordercolorlight="#800000" align="right">
  ...
  <TR>
    <TD vAlign=middle width=170 height="41" bgcolor="#FDCC64" align="center">
    <p align="left">
    <b><font color="#993333" size="3">&nbsp;&nbsp; <a href = "/SeafoodMarket/jsp/backup.jsp"><font color="#993333" >Backup</font></b>
    </TD>
  </TR>
  <TR>
  ...
  <TR>
    <TD vAlign=bottom width=746 height="122" colspan="2">
      ...
      src="/SeafoodMarket/imgs1/home_bot_right.jpg" width=742 
      border=0></p>
    </TD>
  </TR>
      </FORM>
